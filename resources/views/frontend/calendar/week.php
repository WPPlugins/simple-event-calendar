        ...
        <tr>
            ...
            foreach($week->get_days_of_week() as $key => $day_name) {
                ...
                if(empty($current_day_events) ){
                    ?>
                    <td class="gd_calendar_week_cell" rel='<?php echo $week_date; ?>'></td>
                    <?php
                }
                else{
                    ?>
                    <td class="gd_calendar_week_cell" rel='<?php echo $week_date; ?>'>
                        <?php
                        $counter = 0;
                            ...
                            if(strtolower($hour) === $day_key){
                                ...
                                foreach ($current_hour_events as $item => $event_id){
                                    ...
                                    if($count < 3){
                                        ...
                                        ?>
                                        <div class="gd_calendar_week_box <?php echo $color . ' ' . $background; ?>">
