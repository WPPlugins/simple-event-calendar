    ...
    <table id="event_gen_option" class="event_gen_option">
        ...
        <tr class="event_front_field">
            ...
            <td><?php
                ...
                <?php } else {
                    echo date("h:i a", strtotime(esc_html($event->get_start_date()))) . " " . __('to', 'gd-calendar') . " " . date("h:i a", strtotime(esc_html($event->get_end_date())));
                } ?>
            </td>
        </tr>
            ...
            <tr class="event_front_field">
                ...
                <td><?php
                    ...
                    switch ($event->get_repeat_type()) {
                        case 1:
                            echo ' ' . absint($event->get_repeat_day()) . ' ';
                            _e('days', 'gd-calendar');
                            break;
                        case 2:
                            echo ' ' . absint($event->get_repeat_month()) . ' ';
                            _e('months', 'gd-calendar');
                            break;
                        case 3:
                            echo ' ' . absint($event->get_repeat_year()) . ' ';
                            _e('years', 'gd-calendar');
                            break;
                    }
                    ?>
                </td>
